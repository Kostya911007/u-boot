...
#define CONFIG_SYS_BOARD_STR		"STM32F4 DISCOVERY"
#define CONFIG_SYS_BOARD_REV_STR	"B.2"

/*
 * Monitor prompt
 */
#define CONFIG_SYS_PROMPT		"stm32f4-discovery> "
...
/**
 * Clock configuration - use internal source 16MHz
 */ 
#define CONFIG_STM32_SYS_CLK_HSI
...
#define CONFIG_STM32_USART_RX_IO_PORT	0	/* PORTB */
#define CONFIG_STM32_USART_TX_IO_PIN	2	/* GPIO2 */
#define CONFIG_STM32_USART_RX_IO_PIN	3	/* GPIO3 */
...
#define CONFIG_HOSTNAME			stm32f4-discovery
#define CONFIG_BOOTARGS			"stm32_platform=stm32f4-discovery "\
